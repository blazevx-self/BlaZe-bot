...
from app.bot.routers.common import start, help, bot, unknown_commands, profile, balance
...
from app.bot.routers.admin import ban, modify_balance, player_lookup, field_edit
