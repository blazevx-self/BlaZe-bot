...
from app.bot.routers.common import start, help, bot, unknown_commands, profile, balance, rp_commands, error
...
from app.bot.routers.admin import ban, modify_balance, player_lookup, field_edit, reset
